    ...
    if search_engine == 'rankc':
            ...
            if query_result:
                ...
                response = {
                    ...
                    'run_time': query_result.run_time  # Menambahkan run_time di respons
                }
                ...
                # Return kirim hasil
                return render_template('search.html', results=response, current_k=k_value, search_engines=search_engines,
                                    search_engine=search_engine)
            else:
                return render_template('search.html', current_k=k_value)
